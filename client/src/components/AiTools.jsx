  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
      <div className='text-center'>
        ...
        <p className='text-gray-500 max-w-lg mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis repellendus, commodi unde quasi, eius fugit est excepturi veritatis in laudantium iusto consectetur provident earum aliquam ad harum magni id qui!</p>
      </div>
